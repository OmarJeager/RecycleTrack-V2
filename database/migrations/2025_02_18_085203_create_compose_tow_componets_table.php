...
return new class extends Migration
{
    ...
    {
        Schema::create('compose_tow_componets', function (Blueprint $table) {
            $table->id();
            $table->foreignId('machine_id')->constrained('compose_tows')->onDelete('cascade'); // Link to machines table
    ...
    {
        Schema::dropIfExists('compose_tow_componets');
    }
};
