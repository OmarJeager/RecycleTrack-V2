...
return new class extends Migration
{
    ...
    {
        Schema::create('compose_three_componets', function (Blueprint $table) {
            $table->id();
            $table->foreignId('machine_id')->constrained('compose_threes')->onDelete('cascade'); // Link to machines table
    ...
    {
        Schema::dropIfExists('compose_three_componets');
    }
};
